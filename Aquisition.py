...
class DAQ:
    ...
    def apply_termocouple(self,ref, reading):
        ...
        return (6.002517420E-02 + (2.599494743E+01 * (x)) + (-8.130258322E-01 * (x ** 2)) + (6.344980000E-02 * (x ** 3)) + (-4.107082300E-03 * (x ** 4)) + (1.276391000E-04 * (x ** 5)))
    ...
    def read_all(self):
        daq=self.read_daq()
        daq['Time']=time.time()-self.init_time
        if self.yoko1 is not None:
